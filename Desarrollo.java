...
public class Desarrollo extends JFrame implements ActionListener, ChangeListener{
    ...
    public Desarrollo (){
        ...
        serie2=new JLabel();
        redimensionarYEstablecerImagen(serie2, rutaImagenOriginal3, 280, 150);
        serie2.setBounds(160,5,280,150);
        serie2.setVisible(false);
        add(serie2);

        String rutaImagenOriginal4 = "images/P1.png";
        paralelo2=new JLabel();
        redimensionarYEstablecerImagen(paralelo2, rutaImagenOriginal4, 250, 150);
        paralelo2.setBounds(180,5,250,150);
